...
public class StopwatchFragment extends BaseFragment implements StopwatchService.Listener, ServiceConnection {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        share.setOnClickListener(v -> {
            if (service != null) {
                ...
                StringBuilder content = new StringBuilder().append(Objects.requireNonNull(getContext()).getString(R.string.title_time, time)).append("\n");
                long total = 0;
    ...
    public void onDestroyView() {
        ...
        if (service != null) {
            ...
            Objects.requireNonNull(getContext()).unbindService(this);
            if (!isRunning)
    ...
    public void onStateChanged(boolean isRunning) {
        if (isRunning) {
            ...
            AnimatedVectorDrawableCompat drawable = AnimatedVectorDrawableCompat.create(Objects.requireNonNull(getContext()), R.drawable.ic_play_to_pause);
            if (drawable != null) {
            ...
            AnimatedVectorDrawableCompat drawable = AnimatedVectorDrawableCompat.create(Objects.requireNonNull(getContext()), R.drawable.ic_pause_to_play);
            if (drawable != null) {
                toggle.setImageDrawable(drawable);
                drawable.start();
